    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-sm-8 col-sm-offset-2">
          <h3>Home Users</h3><br/>
          <h5>We are faster, smarter and cheaper than the Geek Squad, Firedog or any other canned tech support that the large stores try to sell.  We will ensure your data is backed up, protected and restored during every support call.</h5>
          <ul>
